...
export default function Register() {
    ...
    href="/"
<<<<<<< HEAD
    className="top-6 left-4 md:left-[52%] p-2 flex items-center space-x-1 text-[#EF3167] hover:text-[#EF3167] transition-transform duration-300 hover:scale-110 animate-pulseArrow z-30"
=======
